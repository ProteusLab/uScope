    ...
    expected = {
        ...
        2: (
            ...
            "MemRead",
            {
                ...
                PipelineStage.RENAME: 2150,
                PipelineStage.DISPATCH: 2200,
                PipelineStage.ISSUE: 2300,
                PipelineStage.COMPLETE: 2400,
...
def test_parse_pipelined(trace_with_pipelined):
    ...
    expected = {
        53: (
            ...
            "IntDiv",
            {
                PipelineStage.FETCH: 137000,
                PipelineStage.DECODE: 137500,
                PipelineStage.RENAME: 138000,
                PipelineStage.DISPATCH: 139000,
                PipelineStage.ISSUE: 192500,
                PipelineStage.COMPLETE: 202500,
        ...
        54: (
            ...
            "IntAlu",
            {
                ...
                PipelineStage.RENAME: 138000,
                PipelineStage.DISPATCH: 139000,
                PipelineStage.ISSUE: 202500,
                PipelineStage.COMPLETE: 203000,
        ...
        55: (
            ...
            "MemWrite",
            {
                ...
                PipelineStage.RENAME: 138000,
                PipelineStage.DISPATCH: 139000,
                PipelineStage.ISSUE: 203000,
                PipelineStage.COMPLETE: 203500,
...
def test_parse_unordered(trace_with_unordered):
    ...
    expected = {
        2: (
            ...
            "MemRead",
            {
                PipelineStage.FETCH: 78500,
                PipelineStage.DECODE: 79000,
                PipelineStage.RENAME: 79500,
                PipelineStage.DISPATCH: 80500,
                PipelineStage.ISSUE: 81000,
                PipelineStage.COMPLETE: 81500,
        ...
        5: (
            ...
            "IntAlu",
            {
                ...
                PipelineStage.RENAME: 79500,
                PipelineStage.DISPATCH: 80500,
                PipelineStage.ISSUE: 80500,
                PipelineStage.COMPLETE: 81000,
